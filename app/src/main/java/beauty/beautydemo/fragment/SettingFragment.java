...
import beauty.beautydemo.base.BaseNoteFragment;
 ...
 */
public class SettingFragment extends BaseNoteFragment{
...
//        return Arrays.<Object>asList(new DataModule());
    ...
    private void initFeedbackPreference(){
        Uri uri = Uri.parse("mailto:kkooff114@gmail.com");
...
//        });
    ...
    private void changeTheme(ThemeUtils.Theme theme){
        ...
        //activity.recreate();
        EventBus.getDefault().post(AppParms.CHANGE_THEME_EVENT);
        activity.finish();
    }
}
