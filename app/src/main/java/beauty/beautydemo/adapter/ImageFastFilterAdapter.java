 ...
 */
public class ImageFastFilterAdapter extends BeautyBaseRecyclerAdapter<ImageFastFilterAdapter.ViewHolder> {
    ...
    public ImageFastFilterAdapter(Context context, ArrayList<BasicFilter> list) {
        mContext = context;
