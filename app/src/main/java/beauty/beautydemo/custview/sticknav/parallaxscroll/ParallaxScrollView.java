package beauty.beautydemo.custview.sticknav.parallaxscroll;
...
public class ParallaxScrollView extends ScrollView {
	...
	protected void init(Context context, AttributeSet attrs) {
		TypedArray typeArray = context.obtainStyledAttributes(attrs, R.styleable.beautyproject);
		this.parallaxFactor = typeArray.getFloat(R.styleable.beautyproject_parallax_factor, DEFAULT_PARALLAX_FACTOR);
		this.alphaFactor = typeArray.getFloat(R.styleable.beautyproject_alpha_factor, DEFAULT_ALPHA_FACTOR);
		this.innerParallaxFactor = typeArray.getFloat(R.styleable.beautyproject_inner_parallax_factor, DEFAULT_INNER_PARALLAX_FACTOR);
		this.numOfParallaxViews = typeArray.getInt(R.styleable.beautyproject_parallax_views_num, DEFAULT_PARALLAX_VIEWS);
		typeArray.recycle();
	}
