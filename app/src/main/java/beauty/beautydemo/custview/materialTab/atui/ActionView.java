package beauty.beautydemo.custview.materialTab.atui;
...
import beauty.beautydemo.custview.materialTab.atui.action.Action;
import beauty.beautydemo.custview.materialTab.atui.action.BackAction;
import beauty.beautydemo.custview.materialTab.atui.action.CloseAction;
import beauty.beautydemo.custview.materialTab.atui.action.DrawerAction;
import beauty.beautydemo.custview.materialTab.atui.action.LineSegment;
import beauty.beautydemo.custview.materialTab.atui.action.PlusAction;
import beauty.beautydemo.custview.materialTab.atui.util.BakedBezierInterpolator;
import beauty.beautydemo.custview.materialTab.atui.util.UiHelper;
...
public class ActionView extends View {
    ...
    /**
     * Set the color used for drawing an { at.markushi.ui.action.Action}.
     *
     * @param color
     */
     ...
     *
     * @param action setAction(at.markushi.ui.action.Action, boolean)
     *               setAction(at.markushi.ui.action.Action, boolean, int)
     *               setAction(at.markushi.ui.action.Action, at.markushi.ui.action.Action, int, long)
     */
