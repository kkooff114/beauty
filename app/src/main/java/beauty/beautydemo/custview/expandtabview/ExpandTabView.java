...
import beauty.beautydemo.custview.ViewBaseAction;
...
public class ExpandTabView extends LinearLayout implements OnDismissListener {
	...
	private int popup_main_background = R.color.white;
	...
	private void startAnimation(int i) {
		...
		if (popupWindow == null) {
			popupWindow = new PopupWindow(mViewArray.get(selectPosition),
					displayWidth, LayoutParams.WRAP_CONTENT);
	...
	public void setPopupMainBackground(int Rcolor) {
		this.popup_main_background = Rcolor;
	}
