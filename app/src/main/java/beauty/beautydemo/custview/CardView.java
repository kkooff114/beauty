...
public abstract class CardView extends LinearLayout implements View.OnClickListener {
    ...
    public CardView(Context context, CardGroup group, int cardThemeColor) {
        super(context);
        mContext = context;
    ...
    private void initView() {
        ...
        switch (cardColor) {
            case CARD_COLOR_RED:
                this.setBackground(getResources().getDrawable(R.drawable.bg_corner_red));
                break;
            case CARD_COLOR_GREEN:
                this.setBackground(getResources().getDrawable(R.drawable.bg_corner_green));
                break;
            case CARD_COLOR_YELLOW:
                this.setBackground(getResources().getDrawable(R.drawable.bg_corner_yellow));
                break;
            case CARD_COLOR_ORANGE:
                this.setBackground(getResources().getDrawable(R.drawable.bg_corner_orange));
                break;
            default:
                this.setBackground(getResources().getDrawable(R.drawable.bg_corner_red));
                break;
...
//        head.setBackgroundColor(getResources().getColor(R.color.theme_color));
        ...
        //card_head close
        final ImageView close = new ImageView(mContext);
        ...
        close.setBackground(getResources().getDrawable(R.drawable.ic_close_grey));
        ...
        menu.setBackground(getResources().getDrawable(R.drawable.ic_menu_grey));
        head.addView(menu);
